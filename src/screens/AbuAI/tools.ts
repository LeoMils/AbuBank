...
const FAMILY: FamilyMember[] = [
  { canonicalName: 'Mor', hebrew: 'מור', aliases: ['מור', 'מורי'], relationship: 'daughter', relationshipHebrew: 'הבת', spouse: 'רפי', children: ['אופיר', 'אילון', 'עילי', 'אדר'] },
  { canonicalName: 'Leo', hebrew: 'לאו', aliases: ['לאו', 'ליאו'], relationship: 'son', relationshipHebrew: 'הבן', children: ['עדי', 'נועם'] },
  { canonicalName: 'Raphi', hebrew: 'רפי', aliases: ['רפי'], relationship: 'son-in-law', relationshipHebrew: 'חתן (בעל של מור)' },
  { canonicalName: 'Ofir', hebrew: 'אופיר', aliases: ['אופיר'], relationship: 'grandson', relationshipHebrew: 'נכד (בן של מור ורפי)', spouse: 'ירדן', children: ['אנאבל', 'ארי'] },
  { canonicalName: 'Yarden', hebrew: 'ירדן', aliases: ['ירדן'], relationship: 'granddaughter-in-law', relationshipHebrew: 'כלה (אשת אופיר)' },
  { canonicalName: 'Eylon', hebrew: 'אילון', aliases: ['אילון'], relationship: 'grandson', relationshipHebrew: 'נכד (בן של מור ורפי)', spouse: 'גלעד' },
  { canonicalName: 'Gilad', hebrew: 'גלעד', aliases: ['גלעד'], relationship: 'grandson-in-law', relationshipHebrew: 'בן זוג של אילון' },
  { canonicalName: 'Ilai', hebrew: 'עילי', aliases: ['עילי', 'עילאי'], relationship: 'grandson', relationshipHebrew: 'נכד (בן של מור ורפי)', notes: 'עבר לאחרונה לדירה חדשה' },
  { canonicalName: 'Adar', hebrew: 'אדר', aliases: ['אדר'], relationship: 'grandson', relationshipHebrew: 'נכד (הצעיר של מור ורפי)' },
  { canonicalName: 'Adi', hebrew: 'עדי', aliases: ['עדי'], relationship: 'granddaughter', relationshipHebrew: 'נכדה (בת של לאו)' },
  { canonicalName: 'Noam', hebrew: 'נועם', aliases: ['נועם'], relationship: 'grandson', relationshipHebrew: 'נכד (בן של לאו)', notes: 'נסע לאחרונה לבואנוס איירס' },
  { canonicalName: 'Anabel', hebrew: 'אנאבל', aliases: ['אנאבל'], relationship: 'great-granddaughter', relationshipHebrew: 'נינה (בת של אופיר וירדן)' },
  { canonicalName: 'Ari', hebrew: 'ארי', aliases: ['ארי'], relationship: 'great-granddaughter', relationshipHebrew: 'נינה (בת של אופיר וירדן)' },
  ...
  { canonicalName: 'Tutsi', hebrew: 'טוטסי', aliases: ['טוטסי', 'טוצי'], relationship: 'pet', relationshipHebrew: 'הכלב' },
