...
const ONLINE_HE_SPORTS = /כדורגל|כדורסל|מכבי|הפועל|תוצאות|מי ניצח|מי ניצחה|משחק(?:ים|י)?\s+(?:אתמול|היום|מחר|הערב|של|ה?יום)|איזה משחקים|מונדיאל|אליפות|ליגה|גביע|נבחרת|של\s+המשחק|מה\s+היה\s+במשחק|תוצאת\s+המשחק/
