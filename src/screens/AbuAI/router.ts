...
const FAMILY_PATTERNS = /מי (זה|זאת|זו|הוא|היא)\s|מי ה(בן|בת|נכד|נכדה)|איך קוראים ל|מה הקשר (של|עם)|איך .+ קשור|הנכד שלי|הנכדה שלי|הבן שלי|הבת שלי|הילדים שלי|הנכדים שלי|ספרי לי על ה(ילדים|נכדים|בנים|בנות|נכדות|משפחה)|הילדים של |הנכדים של |כמה (ילדים|נכדים|בנים|בנות) יש|מה שלום ה(ילדים|נכדים|בנים|בנות)/i
