...
const CALENDAR_HEBREW_LOOSE = /מה קורה ה?שבוע|מתי (יש לי )?ה?(רופא|רופאה|דוקטור|דוקטורה|דנטיסט|תור|פגישה|אירוע)|מתי ה(תור|פגישה|אירוע).{0,12}(שלי|הבא|הבאה|הקרוב|הקרובה)|יש (אירוע|תור|פגישה).{0,12}ביומן|יש לי (פגישה|אירוע|תור) (מחר|היום|השבוע)|תזכירי לי|תזכרי לי|יש לי יום עמוס|יום עמוס|אני פנוי[הא]? השבוע|פנוי[הא]? השבוע|פנוי[הא]? מחר|מה יש .{0,8}אחרי הצהריים|יש לי .{0,8}אחרי הצהריים/i
