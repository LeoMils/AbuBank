...
const CALENDAR_UPCOMING = /מה יש (לי )?השבוע|מה יש בשבוע|מה יש שבוע הבא|שבוע הבא\??$|מה הפגישות הקרובות|מה התורים הקרובים|מה האירועים הקרובים|יש לי משהו .{0,16}השבוע|מה התוכנית|מה יש (לי )?ביומן|מה יש ביומן/i
