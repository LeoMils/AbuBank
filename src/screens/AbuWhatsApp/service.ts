...
לא להגזים. לא לצחוק עליה. פשוט היא.`,
  ...
  'יותר שגיאות': `הרבה שגיאות autocorrect — כאילו היא כתבה מהר מדי ו הטלפון "עזר".
חובה: לפחות 4-5 שגיאות שונות: מאכלת, אכשיו, רווחים ב/ל/ו, ה→א בסופי מילים, מילה שגויה ואז "סליחה [תיקון]" בסוף.
הודעת תיקון אחרי: "סליחה [מילה נכונה]"
דוגמה: "יום הולדת שמחא שמחא ל אדר החמוד שלי אני מאכלת לו הרבה בריאותא ו הצלחא.סליחה בריאות"`,
...
דוגמה: "ישששששש❤️❤️ איזא יופי💃 משפחה אהובה שלי🥰 אוהבת אתכם מאוד מאוד מאוד💋💚"`,
  ...
  'מצחיק': `הודעה מצחיקה — סיפור קטן, תיקון מביך של טעות, גילוי טכנולוגי, רכילות על טוצי.
Ja ja ja — אבל מאהבה תמיד.
דוגמאות לנושאים: הטלפון כתב משהו מוזר ו היא שלחה ואז "סליחה האוטוקורקט", טוצי עשה משהו מצחיק, גילתה פיצ'ר חדש בטלפון.
לא להיות אכזרית — רק חמה ו קצת מביכה.`,
}
