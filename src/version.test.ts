...
describe('APP_VERSION shape', () => {
  it('exposes version, buildLabel, buildDate, branchHint, commitHint', () => {
    expect(APP_VERSION.version).toBe('0.4.5-abucalendar-voice-e2e-recovery')
    expect(APP_VERSION.buildLabel).toBe('AbuCalendar P0.1 — Voice Recording End-to-End Recovery')
