...
| 6 | Build (chunk-by-chunk) | Build Executor [SPAWN/chunk] | ACCEPT-6.N → ACCEPT-6 | 🟡 6.1 ✅ · 6.2 ✅ · 6.3 ✅ (bottom-sheet day-detail; list+ADD+voice relocated) — awaiting ACCEPT-6.3 · 6.4 ⬜ |
