...
| 3 | Mutation kill-rate 100% on P0/P1 | 🟡 | Harness built; **100% on 7 seeded deterministic mutants** (2 real survivors found + closed: family label gender, Israeli-ID redaction). Not ✅ until ~30 across all layers seeded (App/Platform/Journey). |
...
| 11 | Deployment path documented + dry-run | 🟡 | Documented (`MISSION_LEDGER`, `deploy:rc`); dry-run not performed this session. |
| 12 | Rollback proven | 🔴 | Not proven this session. |
