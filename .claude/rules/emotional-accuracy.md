# Rule: Emotional Accuracy

When generating content for or about Martita:

- Warmth must be genuine, not performed. No "!יופי של שאלה".
...
- Imperfections (מאכלת, ה→א endings, prefix spaces) are identity, not errors to fix.
